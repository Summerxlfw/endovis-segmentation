...
data_root = '/home/summer/endovis/endovis2017_binary_official'
...
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(type='Resize', scale=(1920, 1088), keep_ratio=False),  # 1088 is divisible by 16
    dict(type='LoadAnnotations'),
    dict(type='PackSegInputs')
]
...
model = dict(
    ...
    test_cfg=dict(mode='whole')  # Use whole image inference instead of slide
)
...
work_dir = './work_dirs/endovis2017_binary_official'
