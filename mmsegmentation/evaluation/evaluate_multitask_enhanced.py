#!/usr/bin/env python3
"""Evaluate enhanced multi-task segmentation model on EndoVis 2017 dataset."""
...
def main():
    parser = argparse.ArgumentParser(description='Evaluate enhanced multi-task model')
    ...
    for fold in folds:
        # Use enhanced config and checkpoint paths
        config_path = f'{base_dir}/configs/endovis/endovis2017_multitask_enhanced_fold{fold}.py'
        checkpoint_path = f'{base_dir}/work_dirs/multitask/endovis2017_multitask_enhanced_fold{fold}/iter_40000.pth'
